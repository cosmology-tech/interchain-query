...
export declare const cosmosAminoConverters: {
    ...
    "/cosmos.vesting.v1beta1.MsgCreateClawbackVestingAccount": {
        aminoType: string;
        toAmino: (message: import("./vesting/v1beta1/tx").MsgCreateClawbackVestingAccount) => import("./vesting/v1beta1/tx").MsgCreateClawbackVestingAccountAmino;
        fromAmino: (object: import("./vesting/v1beta1/tx").MsgCreateClawbackVestingAccountAmino) => import("./vesting/v1beta1/tx").MsgCreateClawbackVestingAccount;
    };
    "/cosmos.vesting.v1beta1.MsgClawback": {
        aminoType: string;
        toAmino: (message: import("./vesting/v1beta1/tx").MsgClawback) => import("./vesting/v1beta1/tx").MsgClawbackAmino;
        fromAmino: (object: import("./vesting/v1beta1/tx").MsgClawbackAmino) => import("./vesting/v1beta1/tx").MsgClawback;
    };
