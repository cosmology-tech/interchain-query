...
export declare const createRpcQueryHooks: (rpc: ProtobufRpcClient | undefined) => {
    /** CurrentPlan queries the current upgrade plan. */ useCurrentPlan: <TData = QueryCurrentPlanResponse>({ request, options }: UseCurrentPlanQuery<TData>) => any;
    /** AppliedPlan queries a previously applied upgrade plan by its name. */ useAppliedPlan: <TData_1 = QueryAppliedPlanResponse>({ request, options }: UseAppliedPlanQuery<TData_1>) => any;
    /**
     * UpgradedConsensusState queries the consensus state that will serve
     * as a trusted kernel for the next version of this chain. It will only be
     * stored at the last height of this chain.
    ...
    /** Returns the account with authority to conduct upgrades */ useAuthority: <TData_4 = QueryAuthorityResponse>({ request, options }: UseAuthorityQuery<TData_4>) => any;
};
