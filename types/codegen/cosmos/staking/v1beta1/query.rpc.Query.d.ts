...
export declare const createRpcQueryHooks: (rpc: ProtobufRpcClient | undefined) => {
    ...
    /** Validator queries validator info for given validator address. */ useValidator: <TData_1 = QueryValidatorResponse>({ request, options }: UseValidatorQuery<TData_1>) => any;
    /** ValidatorDelegations queries delegate info for given validator. */ useValidatorDelegations: <TData_2 = QueryValidatorDelegationsResponse>({ request, options }: UseValidatorDelegationsQuery<TData_2>) => any;
    /** ValidatorUnbondingDelegations queries unbonding delegations of a validator. */ useValidatorUnbondingDelegations: <TData_3 = QueryValidatorUnbondingDelegationsResponse>({ request, options }: UseValidatorUnbondingDelegationsQuery<TData_3>) => any;
    /** Delegation queries delegate info for given validator delegator pair. */ useDelegation: <TData_4 = QueryDelegationResponse>({ request, options }: UseDelegationQuery<TData_4>) => any;
    /**
     * UnbondingDelegation queries unbonding info for given validator delegator
     * pair.
     */
    useUnbondingDelegation: <TData_5 = QueryUnbondingDelegationResponse>({ request, options }: UseUnbondingDelegationQuery<TData_5>) => any;
    /** DelegatorDelegations queries all delegations of a given delegator address. */ useDelegatorDelegations: <TData_6 = QueryDelegatorDelegationsResponse>({ request, options }: UseDelegatorDelegationsQuery<TData_6>) => any;
    /**
     * DelegatorUnbondingDelegations queries all unbonding delegations of a given
     * delegator address.
     */
    ...
    /** Redelegations queries redelegations of given address. */ useRedelegations: <TData_8 = QueryRedelegationsResponse>({ request, options }: UseRedelegationsQuery<TData_8>) => any;
    /**
     * DelegatorValidators queries all validators info for given delegator
     * address.
     */
    ...
    /** HistoricalInfo queries the historical info for given height. */ useHistoricalInfo: <TData_11 = QueryHistoricalInfoResponse>({ request, options }: UseHistoricalInfoQuery<TData_11>) => any;
    /** Pool queries the pool info. */ usePool: <TData_12 = QueryPoolResponse>({ request, options }: UsePoolQuery<TData_12>) => any;
    /** Parameters queries the staking parameters. */ useParams: <TData_13 = QueryParamsResponse>({ request, options }: UseParamsQuery<TData_13>) => any;
};
