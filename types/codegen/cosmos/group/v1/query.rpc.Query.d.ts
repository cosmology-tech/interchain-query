...
export declare const createRpcQueryHooks: (rpc: ProtobufRpcClient | undefined) => {
    ...
    /** GroupPolicyInfo queries group policy info based on account address of group policy. */ useGroupPolicyInfo: <TData_1 = QueryGroupPolicyInfoResponse>({ request, options }: UseGroupPolicyInfoQuery<TData_1>) => any;
    /** GroupMembers queries members of a group */ useGroupMembers: <TData_2 = QueryGroupMembersResponse>({ request, options }: UseGroupMembersQuery<TData_2>) => any;
    /** GroupsByAdmin queries groups by admin address. */ useGroupsByAdmin: <TData_3 = QueryGroupsByAdminResponse>({ request, options }: UseGroupsByAdminQuery<TData_3>) => any;
    /** GroupPoliciesByGroup queries group policies by group id. */ useGroupPoliciesByGroup: <TData_4 = QueryGroupPoliciesByGroupResponse>({ request, options }: UseGroupPoliciesByGroupQuery<TData_4>) => any;
    /** GroupsByAdmin queries group policies by admin address. */ useGroupPoliciesByAdmin: <TData_5 = QueryGroupPoliciesByAdminResponse>({ request, options }: UseGroupPoliciesByAdminQuery<TData_5>) => any;
    /** Proposal queries a proposal based on proposal id. */ useProposal: <TData_6 = QueryProposalResponse>({ request, options }: UseProposalQuery<TData_6>) => any;
    /** ProposalsByGroupPolicy queries proposals based on account address of group policy. */ useProposalsByGroupPolicy: <TData_7 = QueryProposalsByGroupPolicyResponse>({ request, options }: UseProposalsByGroupPolicyQuery<TData_7>) => any;
    /** VoteByProposalVoter queries a vote by proposal id and voter. */ useVoteByProposalVoter: <TData_8 = QueryVoteByProposalVoterResponse>({ request, options }: UseVoteByProposalVoterQuery<TData_8>) => any;
    /** VotesByProposal queries a vote by proposal. */ useVotesByProposal: <TData_9 = QueryVotesByProposalResponse>({ request, options }: UseVotesByProposalQuery<TData_9>) => any;
    /** VotesByVoter queries a vote by voter. */ useVotesByVoter: <TData_10 = QueryVotesByVoterResponse>({ request, options }: UseVotesByVoterQuery<TData_10>) => any;
    /** GroupsByMember queries groups by member address. */ useGroupsByMember: <TData_11 = QueryGroupsByMemberResponse>({ request, options }: UseGroupsByMemberQuery<TData_11>) => any;
    /** TallyResult queries the tally of a proposal votes. */ useTallyResult: <TData_12 = QueryTallyResultResponse>({ request, options }: UseTallyResultQuery<TData_12>) => any;
};
