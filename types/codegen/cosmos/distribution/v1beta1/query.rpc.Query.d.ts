...
export declare const createRpcQueryHooks: (rpc: ProtobufRpcClient | undefined) => {
    ...
    /** ValidatorOutstandingRewards queries rewards of a validator address. */ useValidatorOutstandingRewards: <TData_1 = QueryValidatorOutstandingRewardsResponse>({ request, options }: UseValidatorOutstandingRewardsQuery<TData_1>) => any;
    /** ValidatorCommission queries accumulated commission for a validator. */ useValidatorCommission: <TData_2 = QueryValidatorCommissionResponse>({ request, options }: UseValidatorCommissionQuery<TData_2>) => any;
    /** ValidatorSlashes queries slash events of a validator. */ useValidatorSlashes: <TData_3 = QueryValidatorSlashesResponse>({ request, options }: UseValidatorSlashesQuery<TData_3>) => any;
    /** DelegationRewards queries the total rewards accrued by a delegation. */ useDelegationRewards: <TData_4 = QueryDelegationRewardsResponse>({ request, options }: UseDelegationRewardsQuery<TData_4>) => any;
    /**
     * DelegationTotalRewards queries the total rewards accrued by a each
     * validator.
     */
    ...
    /** DelegatorValidators queries the validators of a delegator. */ useDelegatorValidators: <TData_6 = QueryDelegatorValidatorsResponse>({ request, options }: UseDelegatorValidatorsQuery<TData_6>) => any;
    /** DelegatorWithdrawAddress queries withdraw address of a delegator. */ useDelegatorWithdrawAddress: <TData_7 = QueryDelegatorWithdrawAddressResponse>({ request, options }: UseDelegatorWithdrawAddressQuery<TData_7>) => any;
    /** CommunityPool queries the community pool coins. */ useCommunityPool: <TData_8 = QueryCommunityPoolResponse>({ request, options }: UseCommunityPoolQuery<TData_8>) => any;
};
