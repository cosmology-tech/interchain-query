...
export const MsgUpdateClient = {
  ...
  fromSDK(object: MsgUpdateClientSDKType): MsgUpdateClient {
    return {
      ...
      clientMessage: object.client_message ? Any.fromSDK(object.client_message) : undefined,
      signer: object?.signer
    };
  },
  toSDK(message: MsgUpdateClient): MsgUpdateClientSDKType {
    ...
    message.clientMessage !== undefined && (obj.client_message = message.clientMessage ? Any.toSDK(message.clientMessage) : undefined);
    obj.signer = message.signer;
    return obj;
  },
