...
export const QueryConsensusStateHeightsResponse = {
  ...
  fromSDK(object: QueryConsensusStateHeightsResponseSDKType): QueryConsensusStateHeightsResponse {
    return {
      consensusStateHeights: Array.isArray(object?.consensus_state_heights) ? object.consensus_state_heights.map((e: any) => Height.fromSDK(e)) : [],
      pagination: object.pagination ? PageResponse.fromSDK(object.pagination) : undefined
    };
  },
  toSDK(message: QueryConsensusStateHeightsResponse): QueryConsensusStateHeightsResponseSDKType {
    const obj: any = {};
    if (message.consensusStateHeights) {
      obj.consensus_state_heights = message.consensusStateHeights.map(e => e ? Height.toSDK(e) : undefined);
    } else {
