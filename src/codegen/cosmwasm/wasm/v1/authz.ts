...
export const Cosmwasm_wasmv1ContractAuthzLimitX_InterfaceDecoder = (input: _m0.Reader | Uint8Array): MaxCallsLimit | MaxFundsLimit | CombinedLimit | Any => {
  const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
...
export const Cosmwasm_wasmv1ContractAuthzFilterX_InterfaceDecoder = (input: _m0.Reader | Uint8Array): AllowAllMessagesFilter | AcceptedMessageKeysFilter | AcceptedMessagesFilter | Any => {
  const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
  const data = Any.decode(reader, reader.uint32());
  switch (data.typeUrl) {
